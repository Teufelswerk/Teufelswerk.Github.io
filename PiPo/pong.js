...
function update(){
    ...
    // change the score of player, if the ball goes to the left "ball.x<0" computer win, else if "ball.x > canvas.width" the user win
    ...
    //  ball collides with bottom and top walls we inverse the y velocity.
